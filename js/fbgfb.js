        ...
        var d = function(r) {
            ...
            h(n, [{
                ...
                value: function() {
                    ...
                    t.fillRect(0, 0, i, r);
                    i > 24 && r > 24 && (t.roundedRect(32, 32, i - 64, r - 64, 12),
                ...
                value: function(t) {
                    ...
                    var r = this.size.width
                      , n = this.size.height
                      , o = this.protagonist;
                    if (o || ((o = this.createEntity()).speed.x = 0,
                    o.opacity = 1,
                    ...
                    o) {
                        ...
                        o.size = c,
                        o.origin.x = Math.round(.5 * (r - c.width)),
                        o.origin.y = Math.round(.5 * (n - c.height))
                    }
                    var f = []
                      , p = 0
                      , y = !0
                    ...
                    try {
                        for (var m, v = this.entities[Symbol.iterator](); !(y = (m = v.next()).done); y = !0) {
                            var b = m.value;
                            if (b.time += t,
                            b.time >= b.animationFrameDuration) {
                                var w = b.animationFrame + 1;
                                b.time = 0,
                                b.animationFrame = w < b.sprite.frames.length ? w : 0
                            }
                            0 != b.speed.x && (b.origin.x += b.speed.x * t | 0),
                            (b.origin.x > r || b.origin.x <= -b.size.width) && f.push(p),
                            p += 1
                        }
                    } catch (S) {
                        d = !0,
